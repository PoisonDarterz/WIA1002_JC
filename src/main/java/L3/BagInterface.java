...
public interface BagInterface<T> {
    ...
    /**
     * Returns a new bag containing all the elements in this bag and bag2.
    ...
    /**
     * Returns a new bag containing the overlapping entries in this bag and bag2.
     * @param bag2 the second bag
    ...
    /**
     * Returns a new bag containing all entries in this bag after removing those that also occur in bag2.
     * @param bag2 the second bag
