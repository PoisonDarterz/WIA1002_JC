...
{
    public static int progress = 4; // TODO: Change this value as you proceed through parts of the question.
    ...
    public static void testCPU () throws Exception
    {
        ...
        ArrayList<CpuInt> cc = VecUtil.mul(aa, bb); // Vec * Vec (elementwise multiplication)
        VecUtil.printVec(bb);
        VecUtil.printVec(cc);
        System.out.println("---");
    ...
    public static void testGPU () throws Exception
    {
        ...
        ArrayList<GpuInt> cc = VecUtil.mul(aa, bb); // Vec * Vec (elementwise multiplication)
        VecUtil.printVec(bb);
        VecUtil.printVec(cc);
        System.out.println("---");
